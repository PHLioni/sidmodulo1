...
<button type="button" id='btnCadastraMis' class="btn btn-primary mb-2 mr-2" data-toggle="modal" data-target="#cadastraItem" data-sp="<?php echo $sp;?>">Cadastrar Item</button>
    ...
    <tbody>
        <?php foreach ($estoque as $e) : ?>
            ...
            <tr>
                ...
                <td><a id='editaMisBtn' role='button' data-toggle="modal" data-target="#editaMiscelaneas" data-codigo="<?php echo $e['codigoItem']; ?>" data-item="<?php echo $e['item']; ?>" data-quantidade="<?php echo $e['quantidade']; ?>" data-max="<?php echo $e['pedidoMax']; ?>" data-valor="<?php echo $e['valor_un']; ?>" data-id="<?php echo $e['id']; ?>"><span class="fas fa-edit" style="color:blue"></a></span></td>
            </tr>
        <?php endforeach ?>
    </tbody>
</table>
